...
namespace Data.Migrations
{
    ...
    [Migration("20240930160436_MedicalRecordAndPatient")]
    partial class MedicalRecordAndPatient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.AppUserRoles", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Entities.MedicalHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Entities.MedicalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Models.Entities.AppUserRoles", b =>
                {
                    b.HasOne("Models.Entities.AppRole", "AppRole")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Models.Entities.MedicalHistory", b =>
                {
                    b.HasOne("Models.Entities.MedicalRecord", "MedicalRecord")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.Entities.MedicalRecord", b =>
                {
                    b.HasOne("Models.Entities.Patient", "Patient")
                        ...
                        .HasForeignKey("Models.Entities.MedicalRecord", "PatientId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
